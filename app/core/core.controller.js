(function () {
  ...
  function coreController($scope, $interval, $location) {
    ...
    vm.onPreferencesChanged = onPreferencesChanged;
    ...
    function initPreferences() {
      chrome.storage.sync.get(['tab', 'optionsSettings', 'sideTabsSettings'], function (items) {
        ...
        if ((items.optionsSettings.theme == 'system' && isSystemDark) || items.optionsSettings.theme == 'dark') {
          items.tab.textColor = '#e8eaed';
          items.tab.backgroundColor = {
            top: '#292a2d',
            bottom: '#292a2d'
          };
          items.tab.hoverColor = {
            top: '#0f0f10',
            bottom: '#0f0f10'
          };
          items.tab.highlightColor = '#000000';
          items.tab.borderColor = '#000000';
          items.optionsSettings.backgroundColor = '#202124';
        } else {
          items.tab.textColor = '#000000';
          items.tab.backgroundColor = {
            top: '#DBD7D9',
            bottom: '#C4C3C5'
          };
          ...
          items.tab.highlightColor = '#F5F5F5';
          items.tab.borderColor = '#A9A9A9';
          items.optionsSettings.backgroundColor = '#D4D4D4';
